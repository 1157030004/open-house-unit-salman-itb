      ...
      <div className="container px-4 sm:px-8 lg:px-16 xl:px-20 mx-auto">
        <div className="hero-wrapper grid grid-cols-1 md:grid-cols-12 gap-8 items-center">
          <div className="hero-text col-span-6">
            <h1 className=" font-bold text-4xl md:text-5xl max-w-xl  leading-tight">
              Salman Activist's Job Fair
            </h1>
            <h1 className=" font-bold text-4xl md:text-5xl max-w-xl  leading-tight">
              Masjid Salman ITB
            </h1>
            ...
            <p className=" text-base leading-relaxed mt-8 font-semibold">
              Sebuah laman berbasis website untuk para aktivis tingkat akhir
              atau alumni yang berisi informasi lowongan pekerjaan dari
              perusahaan-perusahan yang bermitra dengan Masjid Salman ITB
            </p>
            <div className="get-app flex space-x-5 mt-10 justify-center md:justify-start">
              <button
                onClick={() => window.location.assign("https://salmanitb.com/")}
              ...
              <button
                onClick={() =>
                  window.location.assign("https://kaderisasi.salmanitb.com/")
                }
